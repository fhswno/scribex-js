...
const CATEGORY_COLORS: Record<string, CategoryStyle> = {
  ai: { bg: "var(--blokhaus-muted)", icon: "#3366CC" },
  headings: { bg: "var(--blokhaus-muted)", icon: "#6366F1" },
  blocks: { bg: "var(--blokhaus-muted)", icon: "#8B5CF6" },
  lists: { bg: "var(--blokhaus-muted)", icon: "#10B981" },
  media: { bg: "var(--blokhaus-muted)", icon: "#F59E0B" },
  format: { bg: "var(--blokhaus-muted)", icon: "#EC4899" },
  other: { bg: "var(--blokhaus-muted)", icon: "#6B7280" },
};
  ...
  return createPortal(
    <div
      ...
      style={{
        ...
        overflow: "auto",
        borderRadius: "12px",
        border: "1px solid var(--blokhaus-popover-border, rgba(0, 0, 0, 0.12))",
        backgroundColor: "var(--blokhaus-popover-bg, rgba(255, 255, 255, 0.96))",
        ...
        animation: "blokhaus-menu-enter 180ms cubic-bezier(0.2, 0.9, 0.3, 1)",
                ...
                <button
                  ...
                  style={{
                    ...
                    backgroundColor: isActive
                      ? "var(--blokhaus-accent, #007AFF)"
                      : "transparent",
                    color: isActive
                      ? "var(--blokhaus-accent-foreground, #fff)"
                  ...
                  <div
                    style={{
                      ...
                      background: isActive
                        ...
                        : colors.bg,
                      flexShrink: 0,
                      color: isActive ? "var(--blokhaus-accent-foreground, #fff)" : colors.icon,
                      animation: isActive
                        ? "blokhaus-icon-lift 400ms cubic-bezier(0.34, 1.56, 0.64, 1)"
                        : "none",
                    }}
                  >
                    <item.icon size={16} />
                  ...
                  {shortcut && (
                    <div
                      style={{
                        ...
                        fontWeight: 400,
                        color: isActive
                          ? "var(--blokhaus-accent-foreground, rgba(255, 255, 255, 0.55))"
                          : "var(--blokhaus-text-tertiary)",
                        flexShrink: 0,
