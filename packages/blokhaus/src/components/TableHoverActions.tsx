...
export function TableHoverActions() {
    ...
    (tableEl: HTMLTableElement, tableRect: DOMRect) => {
      ...
      handleEls.forEach((el) => {
        ...
        htmlEl.addEventListener("mouseenter", () => {
          htmlEl.style.backgroundColor = "var(--blokhaus-hover-bg)";
          htmlEl.style.color = "var(--blokhaus-icon-secondary)";
        });
        htmlEl.addEventListener("mouseleave", () => {
          htmlEl.style.backgroundColor = "transparent";
          htmlEl.style.color = "var(--blokhaus-text-tertiary)";
        });
  ...
  const edgeButtonBase: React.CSSProperties = {
    ...
    borderRadius: "4px",
    border: "1px dashed var(--blokhaus-separator)",
  ...
  const MenuButton = ({
    ...
    <button
      ...
      style={{
        ...menuItemStyle,
        ...(destructive ? { color: "var(--blokhaus-destructive, #e03e3e)" } : {}),
      }}
      onMouseEnter={(e) => {
        e.currentTarget.style.backgroundColor = "var(--blokhaus-hover-bg)";
      }}
      onMouseLeave={(e) => {
    ...
    <div data-table-hover-actions>
      ...
      <div
        ...
        style={{
          position: "fixed",
          width: "1px",
          backgroundColor: "var(--blokhaus-accent, #007AFF)",
          opacity: 0.5,
          zIndex: 48,
          visibility: "hidden",
          pointerEvents: "none",
      ...
      <div
        ...
        onMouseEnter={(e) => {
          ...
          el.style.backgroundColor = "var(--blokhaus-muted, #f1f5f9)";
          el.style.color = "var(--blokhaus-accent, #007AFF)";
          el.style.borderColor = "var(--blokhaus-accent, #007AFF)";
        }}
        onMouseLeave={(e) => {
          const el = e.currentTarget;
          el.style.backgroundColor = "transparent";
          el.style.color = "var(--blokhaus-text-tertiary)";
          el.style.borderColor = "var(--blokhaus-separator)";
        }}
        style={{
          ...edgeButtonBase,
          height: "20px",
      ...
      <div
        ...
        onMouseEnter={(e) => {
          const el = e.currentTarget;
          el.style.backgroundColor = "var(--blokhaus-hover-bg)";
          el.style.color = "var(--blokhaus-icon-secondary)";
        }}
        onMouseLeave={(e) => {
          const el = e.currentTarget;
          el.style.backgroundColor = "transparent";
