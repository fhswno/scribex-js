...
const CELL_BG_COLORS = [
  ...
  { label: "Gray", value: "var(--blokhaus-cell-bg-gray)", swatch: "#f1f1ef" },
  { label: "Brown", value: "var(--blokhaus-cell-bg-brown)", swatch: "#f4f0ee" },
  { label: "Orange", value: "var(--blokhaus-cell-bg-orange)", swatch: "#fbecdd" },
  { label: "Yellow", value: "var(--blokhaus-cell-bg-yellow)", swatch: "#fbf3db" },
  { label: "Green", value: "var(--blokhaus-cell-bg-green)", swatch: "#edf3ec" },
  { label: "Blue", value: "var(--blokhaus-cell-bg-blue)", swatch: "#e7f3f8" },
  { label: "Purple", value: "var(--blokhaus-cell-bg-purple)", swatch: "#f4f0f7" },
  { label: "Pink", value: "var(--blokhaus-cell-bg-pink)", swatch: "#f9f0f5" },
  { label: "Red", value: "var(--blokhaus-cell-bg-red)", swatch: "#fdebec" },
];
  ...
  return createPortal(
    <div
      ...
      style={{
        ...
        minWidth: "180px",
        borderRadius: "10px",
        border: "1px solid var(--blokhaus-popover-border)",
        backgroundColor: "var(--blokhaus-popover-bg)",
        backdropFilter: "blur(20px) saturate(180%)",
        WebkitBackdropFilter: "blur(20px) saturate(180%)",
        boxShadow: "var(--blokhaus-popover-shadow)",
        padding: "4px",
        fontFamily:
          ...
          return (
            <div key={item.id} style={{ position: "relative" }}>
              ...
              >
                ...
                <span style={{ fontSize: "10px", color: "var(--blokhaus-text-tertiary)" }}>
                  {"\u25B6"}
                </span>
              </button>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        border:
                          ...
                          (!currentCellBg && color.value === "")
                            ? "2px solid var(--blokhaus-accent, #007AFF)"
                            : "1px solid var(--blokhaus-popover-border)",
                        cursor: "pointer",
                        backgroundColor:
                    ...
                    >
                      {color.swatch === "transparent" && (
                        <span
                          style={{
                            fontSize: "11px",
                            color: "var(--blokhaus-text-tertiary)",
                          }}
                        >
                          {"\u2205"}
                        </span>
          ...
          <div key={item.id}>
            {showSep && (
              <div
                style={{
                  height: "0.5px",
                  backgroundColor: "var(--blokhaus-separator)",
                  margin: "3px 6px",
                }}
              />
            )}
            <button
              ...
              style={{
                ...
                fontSize: "13px",
                color: item.danger
                  ? "var(--blokhaus-destructive, #e03e3e)"
                  : "var(--blokhaus-foreground, #1d1d1f)",
              }}
            >
              {item.label}
            </button>
