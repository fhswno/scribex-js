...
function AIPreviewComponent({
  ...
  return (
    <div
      ...
      style={{
        position: "relative",
        borderInlineStart: "3px solid var(--blokhaus-ai-stream, #3366cc)",
        borderRadius: "8px",
        padding: "16px 20px",
        margin: "8px 0",
        backgroundColor: "var(--blokhaus-ai-stream-bg, rgba(51, 102, 204, 0.05))",
        fontFamily: "var(--blokhaus-font-sans, system-ui, sans-serif)",
      }}
    >
      <div
        style={{
          ...
          fontSize: "12px",
          fontWeight: 500,
          color: "var(--blokhaus-ai-stream, #3366cc)",
      ...
      {status === "error" ? (
        <div
          ...
          style={{
            color: "var(--blokhaus-destructive, #ef4444)",
            fontSize: "14px",
          }}
        >
        ...
        <div
          ...
          style={{
            fontSize: "15px",
            lineHeight: 1.7,
            color: "var(--blokhaus-foreground, #0f172a)",
            whiteSpace: "pre-wrap",
          }}
        >
          {content}
          {status === "streaming" && (
            <span
              style={{
                ...
                backgroundColor: "var(--blokhaus-ai-stream, #3366cc)",
                animation: "blokhaus-cursor-blink 1s step-end infinite",
        ...
        >
          ...
          {status === "error" && retryCount < maxRetries && (
            ...
            >
              <span
                style={{
                  display: "inline-flex",
                  animation: "blokhaus-retry-spin 0.5s ease-in-out",
                }}
                key={retryCount}
              >
          ...
          <button
            ...
            style={{
              ...
              padding: "6px 14px",
              borderRadius: "8px",
              border: "1px solid var(--blokhaus-border, #e2e8f0)",
              fontSize: "13px",
              fontWeight: 500,
              cursor: "pointer",
              backgroundColor: "transparent",
              color: "var(--blokhaus-muted-foreground, #64748b)",
              transition: "opacity 0.15s",
            }}
          >
      ...
      <style
        dangerouslySetInnerHTML={{
          __html: `
            @keyframes blokhaus-cursor-blink {
              0%, 100% { opacity: 1; }
              50% { opacity: 0; }
            }
            @keyframes blokhaus-retry-spin {
