  ...
  return (
    <div
      ...
      style={{
        ...
        aspectRatio: "16 / 9",
        maxHeight: "400px",
        backgroundColor: "var(--blokhaus-muted)",
    ...
    >
      ...
      <div
        style={{
          ...
          right: "12px",
          fontSize: "13px",
          color: "var(--blokhaus-muted-foreground)",
      ...
      >
        <div
          style={{
            width: "32px",
            height: "32px",
            border: "3px solid var(--blokhaus-muted)",
            borderTopColor: "var(--blokhaus-accent)",
            borderRadius: "50%",
            animation: "blokhaus-spin 0.8s linear infinite",
          }}
        />
      </div>
      <style>{`@keyframes blokhaus-spin { to { transform: rotate(360deg); } }`}</style>
    </div>
  );
}
