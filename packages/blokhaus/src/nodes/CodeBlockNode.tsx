  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor: "var(--blokhaus-muted, #f1f5f9)",
        margin: "0.5em 0",
        overflow: "hidden",
        outline: isSelected
    ...
    >
      <div
        style={{
          ...
          padding: "6px 12px",
          borderBottom: "1px solid var(--blokhaus-border, #e2e8f0)",
          fontSize: "12px",
        }}
      >
        <select
        ...
        {isEditing || !highlightedHtml ? (
          <textarea
            ...
            style={{
              ...
              padding: "12px 16px",
              fontFamily:
                'var(--blokhaus-font-mono, ui-monospace, "SFMono-Regular", monospace)',
              fontSize: "13px",
              lineHeight: 1.6,
