      ...
      >
        <button
          ...
          style={{
            ...
            border: "none",
            cursor: "pointer",
            backgroundColor: showEmojiPicker ? "var(--blokhaus-hover-bg)" : "transparent",
            fontSize: "14px",
        ...
        <button
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.color = "var(--blokhaus-destructive, #e03e3e)";
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.backgroundColor = "transparent";
            e.currentTarget.style.color = "var(--blokhaus-text-tertiary)";
          }}
        >
