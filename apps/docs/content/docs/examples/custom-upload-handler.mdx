...
export const s3UploadHandler: UploadHandler = async (file: File): Promise<string> => {
...
export const r2UploadHandler: UploadHandler = async (file: File): Promise<string> => {
...
export const supabaseUploadHandler: UploadHandler = async (file: File): Promise<string> => {
...
export const mockUploadHandler: UploadHandler = async (file: File): Promise<string> => {
...
import { EditorRoot, ImagePlugin, VideoPlugin, InputRulePlugin, SlashMenu } from '@scribex/core';
import { mockUploadHandler } from '@/lib/upload/mock-handler';

export default function EditorPage() {
  return (
    <EditorRoot namespace="dev-editor" className="min-h-[500px] p-4 border rounded-lg">
      <InputRulePlugin />
      <SlashMenu />
      <ImagePlugin
...
export default function EditorPage() {
  ...
  return (
    <div>
      ...
      <EditorRoot namespace="progress-editor" className="min-h-[500px] p-4 border rounded-lg">
